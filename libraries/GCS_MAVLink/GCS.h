...
public:
    ...
    */
    ...
    struct CCDLInfo {
        ...
        bool primary_route_working{true};
        uint32_t backup_route_last_hb;
        bool backup_route_working{true};
    ...
    static constexpr auto CCDL_FAILOVER_BACKUP_TIMEOUT_MS = 1125;
    static constexpr auto CCDL_FAILOVER_TIMEOUT_ARMING_MS = CCDL_FAILOVER_TIMEOUT_MS * 2;
    static constexpr auto CCDL_FAILOVER_BACKUP_TIMEOUT_ARMING_MS = CCDL_FAILOVER_BACKUP_TIMEOUT_MS * 2;
    static constexpr auto CCDL_FAILOVER_TIMEOUT_US = CCDL_FAILOVER_TIMEOUT_MS * 1000;
    static constexpr auto DOUBLEX_CCDL_FAILOVER_TIMEOUT_US = (2 * CCDL_FAILOVER_TIMEOUT_MS + CCDL_FAILOVER_TIMEOUT_MS / 2) * 1000;
protected:
