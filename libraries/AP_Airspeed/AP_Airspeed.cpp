...
// #endif
    // @Group: 3_
    // @Path: AP_Airspeed_Params.cpp
    AP_SUBGROUPINFO(param[2], "3_", 27, AP_Airspeed, AP_Airspeed_Params),

    // @Group: 4
    // @Path: AP_Airspeed_Params.cpp
    AP_SUBGROUPINFO(param[3], "4_", 28, AP_Airspeed, AP_Airspeed_Params),

    // @Group: 5_
    // @Path: AP_Airspeed_Params.cpp
    AP_SUBGROUPINFO(param[4], "5_", 29, AP_Airspeed, AP_Airspeed_Params),
