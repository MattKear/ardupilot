...
#define AP_SERIALMANAGER_DOUBLE_MAVLINK_BUFSIZE_RX     AP_SERIALMANAGER_MAVLINK_BUFSIZE_RX * 2
#define AP_SERIALMANAGER_DOUBLE_MAVLINK_BUFSIZE_TX     AP_SERIALMANAGER_MAVLINK_BUFSIZE_TX * 2
