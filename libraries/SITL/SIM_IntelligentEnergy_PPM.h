...
./Tools/autotest/sim_vehicle.py --gdb --debug -v ArduCopter -A --uartF=sim:ieppm --speedup=1 --console

param set SERIAL5_PROTOCOL 30  # Generator
param set SERIAL5_BAUD 115200
param set GEN_TYPE 3  # IE24
...
./Tools/autotest/autotest.py --gdb --debug build.ArduCopter fly.ArduCopter.IntelligentEnergy24
...
class IntelligentEnergyPPM : public IntelligentEnergy {
public:

    IntelligentEnergyPPM();
