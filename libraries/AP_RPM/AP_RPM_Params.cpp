...
const AP_Param::GroupInfo AP_RPM_Params::var_info[] = {
    ...
    // @User: Standard
    AP_GROUPINFO_FLAGS("TYPE",    1, AP_RPM_Params, _type, 0, AP_PARAM_FLAG_ENABLE),
    ...
    // @Increment: 0.001
    // @User: Standard
    AP_GROUPINFO("SCALING", 2, AP_RPM_Params, _scaling, 1.0f),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("MAX", 3, AP_RPM_Params, _maximum, 100000),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("MIN", 4, AP_RPM_Params, _minimum, 10),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("MIN_QUAL", 5, AP_RPM_Params, _quality_min, 0.5),
    ...
    // @User: Standard
    AP_GROUPINFO("PIN",    6, AP_RPM_Params, _pin, 54),
    ...
    // @User: Advanced
    AP_GROUPINFO("ESC_MASK",  7, AP_RPM_Params, _esc_mask, 0),
