...
// Enabled 2 is enabled with dummy methods for all vehicles except Sub and SITL
    ...
    #define AP_TEMPERATURE_SENSOR_DRONECAN_ENABLED AP_TEMPERATURE_SENSOR_ENABLED && HAL_ENABLE_LIBUAVCAN_DRIVERS
#endif
#if AP_TEMPERATURE_SENSOR_DRONECAN_ENABLED && !HAL_ENABLE_LIBUAVCAN_DRIVERS
    #error AP_TEMPERATURE_SENSOR_DRONECAN_ENABLED requires HAL_ENABLE_LIBUAVCAN_DRIVERS
#endif
