...
#define TEST_ROTATION(rotation, _x, _y, _z) { \
    ...
    TEST_ROTATION(ROTATION_ROLL_0_PITCH_69_YAW_270, 1.0, -1.292950342945540, -0.572956726705438);
    TEST_ROTATION(ROTATION_ROLL_0_PITCH_111_YAW_270, 1.0, -0.572956726705438, -1.292950342945540);
