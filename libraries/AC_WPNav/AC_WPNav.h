...
public:
    ...
    bool set_wp_destination_loc(const Location& destination, const float arc_rad = 0.0);
    ...
    virtual bool set_wp_destination_NEU_m(const Vector3p& destination_neu_m, bool is_terrain_alt = false, const float arc_rad = 0.0);
    ...
    bool set_wp_destination_next_NEU_m(const Vector3p& destination_neu_m, bool is_terrain_alt = false, const float arc_rad = 0.0);
