...
public:
    ...
    float get_voltage(uint8_t esc_index) { return (float)last_telem[esc_index].voltage*0.01; }
    float get_current(uint8_t esc_index) { return (float)last_telem[esc_index].current*0.01; }
