...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @Values: 0:Report only, 1:Land, 2:AltHold, 3:Land even in Stabilize
    // @User: Advanced
...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Bitmask: 0:Allow Arming,1:Allow Takeoff Without Raising Throttle,2:Ignore pilot yaw,7:Allow weathervaning,8:Dont reset weathervane on WP init
    // @User: Advanced
