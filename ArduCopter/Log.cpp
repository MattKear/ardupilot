...
void Copter::Log_Write_CCDL_Timeout()
{
    ...
    for (uint8_t i = 0; i < 3; i++) {
        const log_CCDL_Timeout pkt {
                ...
                time_us        : time_us,
                instance       : i,
                seq            : ccdl_timeout[i].err[0].seq,
                seq_err        : ccdl_timeout[i].err[0].seq_err,
                time_usec      : ccdl_timeout[i].err[0].time_usec,
                time_usec_err  : ccdl_timeout[i].err[0].time_usec_err,
