...
{
    float yaw_rate_cds;
    if (copter.g2.weathervane.get_yaw_out(yaw_rate_cds, pilot_yaw, hgt_cm*0.01, roll_cdeg, pitch_cdeg, copter.flightmode->is_taking_off(), copter.flightmode->is_landing())) {
